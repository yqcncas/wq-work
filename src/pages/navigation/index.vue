            ...
            <!--<div class="cont">-->
              <!--<div v-if="tab===1">-->
                <!--<swiper class="swiper" :indicator-dots="indicatorDots" :autoplay="autoplay" :circular= 'circular' :interval="interval" :duration="duration">-->
                  ...
                  <!--&lt;!&ndash;<span class="lf-main" v-for="(item, index) in Types1" :key="index" @click="routerTo(item.id)">&ndash;&gt;-->
                  <!--&lt;!&ndash;<span class="Typesrc"><img :src="item.imgUrl"></span>&ndash;&gt;-->
                  <!--&lt;!&ndash;<span class="title">{{ item.tradeName }}</span>&ndash;&gt;-->
                  <!--&lt;!&ndash;</span>&ndash;&gt;-->
                  <!--&lt;!&ndash;&lt;!&ndash;<image :src="item.url" class="slide-image" mode="aspectFill"/>&ndash;&gt;&ndash;&gt;-->
                  <!--&lt;!&ndash;</swiper-item>&ndash;&gt;-->
                <!--</swiper>-->
              <!--</div>-->
              <!--<div v-else>-->
